...
class ErrorTest < Minitest::Test
  ...
  def test_returns_conflict_error_class
    ...
    assert_instance_of OptimalPayments::Error::Conflict, error
    assert_kind_of OptimalPayments::Error::ClientError, error
  ...
  def test_returns_bad_gateway_error_class
    ...
    error = OptimalPayments::Error.error_from_response(response, 502)

    assert_instance_of OptimalPayments::Error::BadGateway, error
    assert_kind_of OptimalPayments::Error::ServerError, error
  ...
  def test_returns_general_error_class_for_unrecognized_code
    ...
    assert_instance_of OptimalPayments::Error, error
